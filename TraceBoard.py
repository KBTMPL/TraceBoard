...
class TraceBoard(object):
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/delete_trace">Delete trace</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    def schedule_trace(self, name="", descr="", target="", binary="", proto="", src_port="", dst_port="", end_date="", end_time="", interval="", count="", psize="", healthcheck="off", button_confirm=""):
        ...
        error_dict = {
            2: "<p>Not implemented binary selected.</p>",
            4: "<p>End timestamp in past or less than 2 interval values from now.</p>",
            8: "<p>Not implemented interval selected.</p>",
            16: "<p>Not implemented protocol selected.</p>",
            32: "<p>Source port out of range.</p>",
            64: "<p>Destination port out of range.</p>",
            128: "<p>Packet size out of range.</p>",
            256: "<p>Number of probes out of range.</p>"
        }
        error_message = ""
                        ...
                        <form method="post" action="schedule_trace">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="binary" class="form-select" id="binary" required>
                            ...
                            <div class="row">
                               <div class="col-md-4 mb-3">
                                    ...
                                    <select name="interval" class="form-select" id="interval" required>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="inputCount" class="form-label">Number of probes</label>
    ...
    @cherrypy.expose
    def delete_trace(self, job_id="", button_confirm=""):
        result = ""
        error_message = ""
        ...
        if button_confirm == "true":
            ...
            argument_list = list()
            argument_list.append('./remove_trace.sh')
            argument_list.append('{}'.format(job_id))
            ...
            if stdout.decode('ascii').strip() == "":
                ...
                error_message = "Failed to remove trace: {}".format(job_id)
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="/delete_trace">Delete trace</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        if result == "OK":
            return header + "\n" + """
                <div class="mx-3">
                    <div class="alert alert-success mt-5 mb-4 text-center" id="remove_trace_success_message" role="alert">Trace successfuly removed.</div>
                    <div class="text-center my-4">
                            <a class="btn btn-primary" href="/delete_trace" role="button">Remove another trace</a>
                    </div>
                </div>
            </body>
            </html>
            ...
            return header + "\n" + """
                        <div class="mx-3">
                            <h1 class="my-4">Delete trace</h1> 
                            <form method="post" action="delete_trace">
                                <div class="mb-3">
                                    <select name="job_id" class="form-select" id="job_id" required>
                                        <option selected value="" disabled selected hidden>Choose job from list</option>
                                        """ + trace_jobs.list_jobs_dropdown(job_id, True) + """
                                    </select>
                                </div>
                                <div class="text-center my-4">
                                    <button type="submit" class="btn btn-primary" name="button_confirm" value="true">Submit</button>
                            ...
                            <div class="alert alert-danger my-4 text-center" id="remove_trace_fail_message" role="alert"> """ + error_message + """</div>
                        </div>
                    </body>
                    <script>
                        window.onload = show_error_message();
                        ...
                        function show_error_message() {
                            var error_message = '""" + error_message + """';
                            if (error_message == "") {
                                document.getElementById('remove_trace_fail_message').style.display = 'none';
                            }
                        }
                    </script>
                    </html>
